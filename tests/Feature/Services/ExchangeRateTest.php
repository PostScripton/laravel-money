...
class ExchangeRateTest extends TestCase
{
    ...
    /** @test */
    public function gettingInfoAboutAnExchangerateService()
    {
        $money = money(1000);
    ...
    /** @test */
    public function anExchangerateServiceDoesNotHaveClass()
    {
        Config::set(
    ...
    /** @test */
    public function anExchangerateServiceClassDoesNotExist()
    {
        Config::set(
            'money.services.' . config('money.service'),
    ...
    /** @test */
    public function anExchangerateServiceClassDoesNotInheritTheMainOne()
    {
        Config::set(
            'money.services.' . config('money.service'),
    ...
    /** @test */
    public function exchangerateConvertingBackAndForthMustHaveNoFailsInNumber()
    {
    ...
    /** @test */
    public function exchangerateHistoricalConverting()
    {
        $rub = money(10000, currency('rub'));
